...
def throughput_calculator(model, args, iteration_time, total_iterations):
    ...
    flops_per_iteration = (24 * checkpoint_activations_factor * batch_size * args.actual_seq_length * num_layers * (hidden_size**2)) * (1. + (args.actual_seq_length / (6. * hidden_size)) + (vocab_size / (16. * num_layers * hidden_size)))
