...
sed "s/CONFIG_BATCH_SIZE/${global_batch_size}/" ${template_json} \
    ...
    | sed "s/CONFIG_RANDOMLTD_ENABLED/false/" \
      > ${config_json}
else
sed "s/CONFIG_BATCH_SIZE/${global_batch_size}/" ${template_json} \
    | sed "s/CONFIG_MBSIZE/${batch_size}/" \
...
run_cmd="deepspeed --master_port ${MASTER_PORT} ${dir}/../../pretrain_bert.py ${megatron_options} ${data_options} ${deepspeed_options} &> ${log_path}/${jobname}_${host}.log" # _${current_time}
echo ${run_cmd}
eval ${run_cmd}
set +x
