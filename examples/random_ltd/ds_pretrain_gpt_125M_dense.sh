...
template_json="configs/ds_config_gpt_0.125B_TEMPLATE.json"
...
run_cmd="deepspeed --num_nodes 8 --num_gpus 8 ${DIR}/../../pretrain_gpt.py ${megatron_options} ${data_options} ${deepspeed_options} &> ${LOG_PATH}/${NAME}_${current_time}.log"
echo ${run_cmd}
eval ${run_cmd}
set +x
