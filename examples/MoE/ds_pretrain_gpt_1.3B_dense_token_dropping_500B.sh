...
LR_DECAY_TOKENS=497000000000 # 260000000000
###############################################################################
### Parallelism configs
...
host="${HOSTNAME}"
NAME="gpt3-${MODEL_SIZE}B-tokendropping-graduallyIncrease-every3.85B-023-${LR}-longerwarmup3b-500BTokenss"
...
CHECKPOINT_PATH="/blob/users/zheweiyao/project/tokendropping/checkpoint/${NAME}"
mkdir -p ${LOG_PATH}
...
megatron_options=" \
        ...
        --increse-length-token-interval 3.85 \
