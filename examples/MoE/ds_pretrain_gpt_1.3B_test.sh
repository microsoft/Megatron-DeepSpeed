...
run_cmd="deepspeed --num_nodes 1 --num_gpus 1 ${DIR}/../../pretrain_gpt.py ${megatron_options} ${data_options} ${deepspeed_options}" # &> ${LOG_PATH}/${NAME}.log"
echo ${run_cmd}
eval ${run_cmd}
set +x
