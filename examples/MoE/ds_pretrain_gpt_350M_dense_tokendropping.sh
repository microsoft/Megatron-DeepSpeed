...
LR_DECAY_TOKENS=397000000000 # 260000000000
###############################################################################
### Parallelism configs
...
host="${HOSTNAME}"
NAME="gpt3-${MODEL_SIZE}B-tokendropping-graduallyIncrease-every1.75B-023-${LR}-longerwarmup3b-400BToken"
...
run_cmd="deepspeed --num_nodes 8 --num_gpus 8 ${DIR}/../../pretrain_gpt.py ${megatron_options} ${data_options} ${deepspeed_options} &> ${LOG_PATH}/${NAME}_continue.log"
echo ${run_cmd}
eval ${run_cmd}
set +x
