...
jobname="${jobname}-cl-vocab-from${cl_vocab_start}-to${cl_vocab_end}-step${cl_vocab_step}-root${cl_vocab_root_degree}"
...
template_json="ds_config_gpt_data_efficiency_vocabrarity_TEMPLATE.json"
config_json="ds_config_gbs${global_batch_size}_mbs${batch_size}_log${log_interval}_zero${zero_stage}_clvocab_from${cl_vocab_start}_to${cl_vocab_end}_step${cl_vocab_step}_root${cl_vocab_root_degree}.json"
