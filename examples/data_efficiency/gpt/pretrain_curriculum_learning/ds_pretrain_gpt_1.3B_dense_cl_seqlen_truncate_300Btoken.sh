...
template_json="ds_config_gpt_data_efficiency_seqlen_TEMPLATE.json"
config_json="ds_config_gbs${global_batch_size}_mbs${batch_size}_log${log_interval}_zero${zero_stage}_cl${cl_seqlen_metric}_from${cl_seqlen_start}_step${cl_seqlen_step}_root${cl_seqlen_root_degree}.json"
